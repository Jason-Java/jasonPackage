...
public class JasonButton extends Button {
    ...
    public JasonButton(Context context) {
        super(context);
    }

    public JasonButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public JasonButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public JasonButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void init(AttributeSet attributeSet) {
        TypedArray attr = getContext().obtainStyledAttributes(attributeSet, R.styleable.JasonButton);
        try {
            //圆角相关
            leftTopRadius = attr.getDimension(R.styleable.JasonButton_ja_leftBottomRadius, 0);
            ...
            strokeColor = attr.getColor(R.styleable.JasonButton_ja_strokeColor, strokeDefaultColor);
            strokeColorPress = attr.getColor(R.styleable.JasonButton_ja_strokeColorPress, strokeColor);
            strokeDefaultColor = strokeColor;

            // 背景颜色相关
            bgColor = attr.getInt(R.styleable.JasonButton_ja_bgColor, bgDefaultColor);
            bgColorPress = attr.getInt(R.styleable.JasonButton_ja_bgColorPress, bgColor);
