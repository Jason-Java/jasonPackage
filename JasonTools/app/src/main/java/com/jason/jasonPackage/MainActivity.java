...
import bioyond_robotic.protocol.RoboticArmPickOrPlace;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.testCmd).setOnClickListener(v -> {

//            IProtocol protocol = new RoboticRetryProtocol();
           IProtocol protocol = new RoboticArmPickOrPlace(1, 1, 1, 1, 1, 1);
